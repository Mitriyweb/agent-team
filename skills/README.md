...
This directory contains composable skill files that define reusable capabilities for autonomous agents.
...
Agents should reference these skills in their role `.md` files or `CLAUDE.md`. For example:
"Apply skill: review-security, review-code-style".
